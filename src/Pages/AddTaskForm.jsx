      ...
      <div className="w-full max-w-md shadow-lg p-6 bg-white rounded-2xl">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} maxLength={50} placeholder="Enter task title" className="mt-1 w-full p-2 border rounded" />
          </div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700">Description</label>
            <textarea value={description} onChange={(e) => setDescription(e.target.value)} maxLength={200} placeholder="Enter task description (optional)" className="mt-1 w-full p-2 border rounded" />
          </div>
          <div className="mb-4">
